      ...
      <div className="row">
        <div className="col-3 text-center gs_reveal">
          <div className="text-left mx-auto d-lg-inline-block">
            <div className="stat text-muted d-inline">15</div>&nbsp;
        ...
        <div className="col-3 text-center gs_reveal">
          <div className="text-left mx-auto d-lg-inline-block">
            <div className="stat text-muted d-inline">11</div>&nbsp;
        ...
        <div className="col-3 text-center gs_reveal">
          <div className="text-left mx-auto d-lg-inline-block">
            <div className="stat text-muted d-inline">7</div>&nbsp;
            <div className="d-inline">YRS</div><br />
        ...
        <div className="col-3 text-center gs_reveal">
          <div className="text-left mx-auto d-lg-inline-block">
            <div className="stat text-muted d-inline">8</div>&nbsp;
            <div className="d-inline">YRS</div><br />
