...
const MainNav = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg container navbar__container navbar-light bg-white justify-content-between fixed-top pt-lg-5">
        ...
        <div
          className="collapse navbar-collapse flex-grow-0 border-top mt-2 pt-2"
